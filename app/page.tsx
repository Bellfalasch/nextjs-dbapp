    ...
    <>
      <section className="hero">
        <div className="hero-body">
          <h1 className="title">X-mas Beer App</h1>
          <h2 className="subtitle">Done so far</h2>
        </div>
      </section>
      <main className="content">
        ...
        <p>
          Currently we will open &quot;add beer&quot; for everyone, the concept
          of events is not used, and voting is just a form you can use for any
          beer at any time. This makes the app simpler to build, constraints are
          enforced by the user instead of the code.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                &quot;Add as you go&quot; means when an event starts, a beer
                must be added to the pool before anyone can vote on it
              </li>
              <li>
          ...
          <li>
            Until everyone have said that they are ready, each user see a
            summary of their given points on the given beer
          </li>
          <li>
            When everyone are done, next beer comes up (or the event stops)
          </li>
        </ul>
        <h2>Functionality</h2>
        <ul>
          ...
          <li>
            A user should be able to edit points for a beer until they click
            ready for next beer.
          </li>
          <li>
          ...
          <li>
            ...
            unhappy with the current one. Let say we get five very strong beers
            in a row, it would be nice to be able to control that in a way.
          </li>
          <li>
            ...
            from the entire list of beers, or just let one person per round
            select from the list. &quot;Next beer&quot; could thus be very
